...
public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        else if (viewHolder instanceof QueueListMediaQueueAdapter.QueueItemViewHolder) {
                QueueListMediaQueueAdapter.QueueItemViewHolder queueHolder
                        = (QueueListMediaQueueAdapter.QueueItemViewHolder) viewHolder;
                ViewCompat.setTranslationX(queueHolder.mContainer, dX);
        }
        } else {
